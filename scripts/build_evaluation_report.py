...
@media(max-width:680px){.topbar nav{display:none}.hero{padding:58px 20px}.hero h1{font-size:43px}.portable{display:none}.shell,.footer{margin-left:18px;margin-right:18px;padding-top:60px}.heading{align-items:flex-start;flex-direction:column}.heading p{text-align:left}.motivation-grid,.flow,.metrics,.result-grid,.surrogate-model-grid,.surrogate-grid,.artifact-summary,.artifact-grid,.gap-grid,.trace-grid,.checkpoint{grid-template-columns:1fr}.metric,.result-card,.surrogate-metric,.motivation,.artifact-summary div,.artifact-card{border-right:0;border-bottom:1px solid var(--line)}.metrics{margin-left:0;margin-right:0}.checkpoint-title{grid-column:auto}.tab-list{overflow-x:auto}.cohorts,.benchmark-table{overflow-x:auto}.cohort{min-width:650px}.benchmark-head,.benchmark summary{min-width:850px}.footer{flex-direction:column}}
