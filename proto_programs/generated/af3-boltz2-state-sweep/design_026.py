...
Use beta=0.15 and implementation seed 0 for five Boltz-2 draws, with separate TM-scores to both reference states. Proto and ProtoFuse must use this same backend, input, and seed. AlphaFold 3 and paper-matched MSAs are optional validation recipes, not execution gates.
"""
