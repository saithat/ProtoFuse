...
Use beta=-0.75 and implementation seed 3 for five AlphaFold3 and five Boltz-2 draws, with separate TM-scores to both reference states. Execution requires explicitly registered reviewed backends and has no unscaled fallback.
"""
